...
WRITE_STAGING_DIR_HOST = "${WRITE_STAGING_DIR}/${MULTIMACH_HOST_SYS}"
WRITE_STAGING_DIR_TARGET = "${WRITE_STAGING_DIR}/${MULTIMACH_TARGET_SYS}"
PKGDATA_DIR = "${STAGING_DIR_HOST}/pkgdata"
WRITE_PKGDATA_DIR = "${WRITE_STAGING_DIR_HOST}/pkgdata"
